...
with tab1:
    ...
    # --------------------------------------   /   Data Upload to Mysql   /   --------------------------------------- #
        ...
        if session_state.data_uploaded:
            ...
            engine = create_engine('mysql+mysqlconnector://root:Lonelyrider16ce133@localhost/bizcard_db', echo=False)
